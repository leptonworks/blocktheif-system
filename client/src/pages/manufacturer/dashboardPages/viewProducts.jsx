            ...
            {filteredProducts.map((product) => (
              ...
              >
                <div className="p-4">
                  ...
                  <button
                    className="w-full mt-4 px-4 py-2 bg-blue-500 text-white font-semibold rounded hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue active:bg-blue-800"
