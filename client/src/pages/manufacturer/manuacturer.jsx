  ...
  return (
    <div className="nav-spacing">
      <div className="divide-y">
        <div className="px-4 py-16 mx-auto bg-black bg-cover sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            ...
            <h2 className="text-base text-gray-100 font-bold underline underline-offset-2 md:text-lg">
              Join our innovative platform to protect your brand and
            ...
            <p className="text-base text-sky-100 whitespace-normal italic font-bold md:text-lg">
              ...
              counterfeit products in the market." - John Smith,
              CEO of XYZ Company
            </p>
            <br />
