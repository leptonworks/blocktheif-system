...
function review() {
  return (
    ...
    <div className="px-4 py-16 bg-gradient-to-r from-blue-600 via-cyan-500 to-teal-500 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
